...
function ProductDescription(props) {
  ...
  let initQuantity = 0;
  try {
    initQuantity = JSON.parse(
      localStorage.getItem(localStorage.getItem("curUser"))
    )[props.location.state.prod_id].quantity;
  } catch {}
  ...
  var sc =
    "http://localhost:4000/upload/" + String(props.location.state.img_url);
  ...
  function addToCart() {
    ...
    if (cartItems != null)
      cartItems[props.location.state.prod_id] = {
        ...props.location.state,
        quantity: Quantity,
        nearexpiry: props.location.state.nearexpiry ? 1 : 0,
      };
        ...
        <Container className="prod">
          <Row>
            <Col style={{ padding: "0px" }}>
              <img fluid src={sc} alt="" width="400" height="450" />
            </Col>
            <Col style={{ padding: "0px" }}>
              <h1>
              ...
              <h6 style={{ marginBottom: "10px" }}>
                <span>Quantity in stock: {props.location.state.instock}</span>
              </h6>
              <h6 style={{ marginBottom: "10px" }}>
                <span>
                  Price per unit: &#8377; {props.location.state.price}
                </span>
              </h6>
              {props.location.state.nearexpiry ? (
                <h6 style={{ marginBottom: "10px" }}>
                  <span>Our Price: {props.location.state.discount}</span>
                </h6>
              ) : null}
              <h6 style={{ marginBottom: "10px" }}>
                <span>
                  Your Total for this item:{" "}
