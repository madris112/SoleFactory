...
function Cart(props) {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/gethistory", {
        params: { username: localStorage.getItem("curUser") },
      })
      .then((response) => {
        ...
        <div className="whole_page">
          <Container>
            {orderHistory.map((data, key) => {
              ...
              if (data.history.Quantity == 0) return;
              return (
                <Row className="row_orders">
                  <Col style={{ padding: "0px" }}>
                    <img
                      ...
                      fluid
                      src={
                        "http://localhost:4000/upload/" + data.product.imgURL
                      }
                      alt=""
                      width="150"
                      height="120"
                  ...
                  <Col className="row_price">
                    <h3>
                      <strong>
                        Your total for this item was:{" "}
                        {data.history.price * data.history.Quantity}
                      </strong>
                    </h3>
                    <br />
                  </Col>
