    ...
    if (ngo === "true") {
      ...
      return (
        <Col
          ...
          sm={6}
          md={4}
          style={{ marginBottom: "0.5%", height: "530px", overflow: "hidden" }}
        >
          <Card onClick={handleClick} className="cardHover" id="cardcss">
            {curr > 3 && (
              <div className="ribbon">
                <span className="ribbon__content">Best Seller</span>
              </div>
            )}
            <Card.Body>
            ...
            <div style={{ height: "100%" }}>
              {nearexpiry ? (
                <h5 style={{ color: "red", marginLeft: "10px" }}>
                  Expiry in <strong> {expiryin} </strong> days !
                </h5>
              ) : null}
              {nearexpiry ? (
              ...
              <div style={{ display: "inline-block", width: "100%" }}>
                <large className="text-right" style={{ marginLeft: "10px" }}>
                  {" "}
                  <FaBoxes
